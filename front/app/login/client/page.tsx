...
<h1 className=' text-gray-600 text-sm w-fit inline-block ml-[30%] mt-[4%]'>Not a member?</h1><Link href={'/register/client'} className=' text-blue-500 underline text-[15px]'>Sign-up now</Link>
