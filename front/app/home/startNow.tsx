...
const StartNow = () => {
  return (
    <div className=''>
<p className='font-bold  text-[#ff2800] tracking-[3px] text-[14px] text-center'>Start Now</p>
<h1 className='text-center font-[800] text-[34px]  text-[#0a0a0a] mb-[5%]'>How it Works</h1>
<div className='grid grid-cols-3 justify-center items-center'>
    <div className='pl-[20%]'>
       <div>
        <img className='text-center ml-[20%] mb-[3%]' src="https://autobid.modeltheme.com/wp-content/uploads/2023/11/autobid-main_how1-2.svg" alt="" />
    ...
    <div className='pl-[20%]'>
       <div>
        <img className='text-center ml-[20%] mb-[3%]' src="https://autobid.modeltheme.com/wp-content/uploads/2023/11/autobid-main_how3.svg" alt="" />
        <h2 className='font-[700] text-[#0a0a0a] text-[20px] mb-[5%]'>Browse and Select a Vehicle</h2>
        <h1 className='font-[100] text-[15px]'>Embark on your journey to automotive excellence with the second step on our auction platform – Browse and Select Vehicles. Immerse yourself in a curated selection of high-quality vehicles spanning various makes, models, and styles</h1>
        </div>
    </div>
    <div className='pl-[20%]'>
       <div>
